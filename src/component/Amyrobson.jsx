import amy from "../img/amyrobson.png";
...
function Amyrobson() {
  return (
    <>
      <div className="flex justify-center items-center sm:m-8">
          ...
          <div className="flex flex-wrap-reverse  lg:flex-nowrap">
            ...
            <div className=" p-4 ">
              <div className="w-full flex items-center justify-start p-2">
                <img src={amy} className="w-10 h-10 mr-3" alt=""></img>
