    ...
    return (
      <> <div className="w-full flex justify-center items-center">
            ...
            <div className="flex flex-col md:flex-row md:justify-between gap-4 mt-4">
                <button  onClick={handleAlert}   className="w-full md:w-auto p-3 bg-gray-400 text-white rounded-lg font-medium text-sm hover:bg-gray-700 focus:ring-4 focus:ring-gray-300">
                  NO, CANCEL
                        </button>
